import fba_scripts
from gurobi_utils import run_substrate_gurobi
import sys
import os
import pickle
import pandas as pd
...
output_dir = DATA / "gurobi_results"
...
# Set envrionment
# -------------------------------------
#solve_env.set_default_env(model=me, aerobic=o2_on_off)
...
result = None
try:
    result = run_substrate_gurobi(model=me, substrate=input_substrate)
